...
screen quick_menu():
    ...
    if quick_menu:
        ...
        fixed:
            ...
            textbutton _("BACK") action Rollback() xpos 1600 ypos 970
            textbutton _("STORY") action ShowMenu('history') xpos 1600 ypos 1000
            #textbutton _("Пропуск") action Skip() alternate Skip(fast=True, confirm=True)
            #textbutton _("Авто") action Preference("auto-forward", "toggle")
            textbutton _("SAVE") action ShowMenu('save') xpos 1600 ypos 940
            #textbutton _("Б.Сохр") action QuickSave()
            #textbutton _("Б.Загр") action QuickLoad()
            textbutton _("OPTIONS") action ShowMenu('preferences') xpos 1600 ypos 1030
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            #imagebutton auto "gui/mm_start_%s.png" xpos 1053 ypos 68 focus_mask True action Start()
        ...
        #imagebutton auto "gui/mm_load_%s.png" xpos 1076 ypos 302 focus_mask True action ShowMenu("load")

        #imagebutton auto "gui/mm_options_%s.png" xpos 1020 ypos 397 focus_mask True action ShowMenu("preferences")
        ...
        if renpy.variant("pc"):
            ...
            #imagebutton auto "gui/mm_quit_%s.png" xpos 1287 ypos 569 focus_mask True action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_start_%s.png" xpos 1053 ypos 68 focus_mask True action Start() activate_sound "audio/click.wav"

        else:

            textbutton _("История") action ShowMenu("history") activate_sound "audio/click.wav"

            textbutton _("Сохранить") action ShowMenu("save") activate_sound "audio/click.wav"

        #textbutton _("Загрузить") action ShowMenu("load")

        imagebutton auto "gui/mm_load_%s.png" xpos 1076 ypos 302 focus_mask True action ShowMenu("load") activate_sound "audio/click.wav"

        imagebutton auto "gui/mm_options_%s.png" xpos 1020 ypos 397 focus_mask True action ShowMenu("preferences") activate_sound "audio/click.wav"
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_quit_%s.png" xpos 1287 ypos 569 focus_mask True action Quit(confirm=not main_menu) activate_sound "audio/click.wav"
...
style button:
    activate_sound "audio/click2.wav"
